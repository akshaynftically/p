...
const Main = () => {
  return (
    <div className='sm:max-w-[90rem] 2xl:max-w-[105rem] w-full mx-auto lg:pb-[80px] px-4 sm:px-6 lg:px-8'>
      <div className='lg:grid lg:grid-cols-12 items-center md:gap-x-[7.5rem]'>
        <div className='col-span-5'>
          ...
          <div className='text-[16px] text-white/[.80] mb-[40px]'>
            COMEARTH is where brands & creators can create unparalleled experiences while consumers
            discover everything at a place
          </div>
