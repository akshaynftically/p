  ...
  return (
    <div className='pb-[25px] lg:pt-[120px] mx-[20px] lg:mx-[80px] mt-[60px] lg:mt-0'>
      ...
      <div className='relative'>
        <div className='hidden lg:flex items-center justify-end bg-gradient-to-l min-w-[100px] from-[#161819] to-[#161718]/0 h-full absolute right-[-50px] top-1/2 -translate-y-1/2 z-[100]'>
          <button onClick={handleOnNextSlide}>
        ...
        <div className='hidden lg:flex items-center justify-start h-full absolute left-[-50px] top-1/2 -translate-y-1/2 z-[100]'>
          <button onClick={handleOnPrevSlide}>
            <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
