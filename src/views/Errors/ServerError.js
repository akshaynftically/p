...
// Sources
import _illustration1 from 'assets/img/illustration/5.svg'
import _illustration2 from 'assets/img/illustration/6.svg'
import {SimpleButton} from '../../components/buttons'

const ServerError = () => {
  return (
    <Fragment>
      <div className='relative bg-no-repeat bg-cover justify-center flex flex-col pt-[67px] lg:pt-0 lg:h-[100vh] bg-[url("assets/img/stars.png")] lg:bg-[url("assets/img/bg/11.png")]'>
