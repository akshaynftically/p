...
const Land = (props) => {
  ...
  return (
    <Fragment>
      ...
      {/* Hero */}
      <div
        className={`absolute flex items-end top-0 transform translate-y-[35%] xs:translate-y-[40%] sm:translate-y-[60%] md:translate-y-[60%] lg:translate-y-[55%] 2xl:translate-y-[70%] w-full justify-center transition-[opacity] duration-[600ms] px-5 ${
