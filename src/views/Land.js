...
const BackButton = ({back, className}) => {
  return (
    <button
      className={`text-white text-[16px] relative py-[11px] pl-[50px] px-[33px] rounded-[50px] ${className}`}
      onClick={back}
    >
    ...
    <Fragment>
      ...
      {land && (
        <>
          {/* Hero */}
          <div
              className={`absolute z-[20] flex items-end top-0 transform translate-y-[35%] xs:translate-y-[40%] sm:translate-y-[60%] md:translate-y-[60%] lg:translate-y-[55%] 2xl:translate-y-[70%] w-full justify-center transition-[opacity] duration-[600ms] px-5 ${
          ...
          >
            <div className='w-full'>
              <div className='text-center relative text-white mb-5'>
                ...
                <h1 className='text-[40px] lg:text-[72px] xs:leading-[1.2] lg:leading-[1.5] font-bold mb-[24px]'>
                  {land.name} Land of <span className='text-gradient'>Commerce</span>
                </h1>
                <div className='flex justify-center items-center mb-[24px]'>
                  <p className='max-w-[80vh] opacity-80 text-[14px]'>
          ...
          <div
              ref={sectionRef}
              className={`relative rounded-t-[16px] z-[20] bg-[#262728] min-h-[100vh] mb-[203px] 3xl:max-w-[120rem] max-w-[100rem] basis-full w-full mx-auto transition-[margin,opacity] duration-[600ms] ${
                  animate ? 'mt-[-25vh] opacity-1' : 'mt-[-10vh] opacity-0'
              }`}
          >
            <button
                className='hidden lg:block absolute top-[-43px] left-[50%] -translate-x-1/2 translate-y-[-100%]'
            ...
            <div className='bg-[url("assets/images/background/hero-1.png")] mb-[60px] lg:px-[128px] flex items-center bg-cover xl:h-[842px]'>
              <div className='text-center text-white xl:max-w-[562px] backdrop-blur-sm bg-gradient-to-b from-[#746897]/60 to-[#688697]/60'>
                <div className='bg-[#1B2023]/50 text-[20px] py-[17px]'>Alpha Launch Coming Soon</div>
                  ...
                  <div className='flex justify-center mb-[34px]'>
                    ...
                    >
                      ...
                      <path
                          ...
                          fill='white'
                          mask='url(#path-6-inside-1_133_169)'
                      />
                      <path
            ...
            <div className='px-[20px] md:px-[58px]'>
              <div className='mb-[97px]'>
                <h4 className='text-white text-[24px] md:text-[36px] font-bold mb-[24px]'>
                  Ut enim ad minim
                </h4>
              ...
              <div className='mb-[124px]'>
                <h3 className='text-[32px] md:text-[52px] font-bold text-white mb-[32px]'>
                  Land Overview
                </h3>
                <div className='sm:grid sm:grid-cols-2 gap-[100px] md-[60px] md:mb-[140px]'>
                  ...
                  <div>
                    ...
                    <p className='text-[#ffffff]/80 mb-[20px]'>
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                      incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
                      exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute
                      irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla
                ...
                <h3 className='text-[32px] lg:text-[52px] leading-[1.2] font-bold text-white mb-[32px]'>
                  We connect Buyers and Sellers in <span className='text-gradient'>Metaverse</span>
                </h3>
                <div className='sm:grid sm:grid-cols-1 lg:grid-cols-2 mb-[140px]'>
                  <img className='hidden lg:block' src={img2} alt='land overview' />

                  <div>
                    <p className='text-[16px] lg:text-[20px] text-white/80 mb-[24px]'>
                      We are growing at a exercitation ullamco laboris nisi ut sed do eiusmod tempor
                    ...
                    <div className='grid grid-cols-2 2xl:grid-cols-3 gap-[10px] md:gap-[20px] mb-[24px]'>
                      <div className='bg-[#363738] py-[28px] pl-[20px] md:min-w-[239px] rounded-[8px]'>
                        <div className='flex items-center gap-[12px]'>
                          ...
                          <div>
                        <span className='block text-white text-[24px] lg:text-[36px] font-[900]'>
                          90 B+
                        </span>
                            <span className='block text-[12px] md:text-[20px] text-white/80'>
                          Total Users
                        </span>
                          </div>
                        </div>
                      ...
                      <div className='bg-[#363738] py-[28px] pl-[20px] md:min-w-[239px] rounded-[8px]'>
                        <div className='flex items-center gap-[12px]'>
                          ...
                          <div>
                        <span className='block text-white text-[24px] lg:text-[36px] font-[900]'>
                          295 <span className='text-[20px] hidden md:block font-bold'>sq km</span>
                        </span>
                ...
                <h3 className='text-[32px] lg:text-[52px] leading-[1.2] font-bold text-white mb-[32px]'>
                  Featured <span className='text-gradient'>Stores</span>
                </h3>
                <Stores />
              </div>
            </div>
            ...
            <div className='mb-[139px]'>
              <div className='px-[20px] md:px-[58px]'>
                <h5 className='text-white text-center text-[24px] md:text-[36px] font-[900] mb-[16px]'>
                  {land.name}
                </h5>
                <h5 className='text-white text-center text-[24px] md:text-[48px] font-[900] mb-[20px]'>
                  {land.name} Land of Commerce
                </h5>
                <div className='flex justify-center mb-[30px]'>
                  <p className='text-white/80 text-[14px] max-w-[890px]'>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                    incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
                    exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute
                    irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla
              ...
              <div className='relative'>
                ...
                <div className='absolute bottom-0 left-1/2 transform -translate-x-1/2 md:left-[unset] md:translate-x-0  md:bottom-20 md:right-10'>
                    ...
                    <div className='grid grid-cols-2 gap-x-[50px] gap-y-[15px]'>
                      ...
                      <div>
                        <div className='text-[32px] font-bold'>
                          8923 <span className='text-[20px] font-normal'>sq.m</span>
                        </div>
                        <div className='text-[20px]'>Land Area</div>
                      </div>
                      <div>
                        <div className='text-[32px] font-bold'>
                          24523 <span className='text-[20px] font-normal'>sq.m</span>
                        </div>
                  ...
                  <div className='border-sq-gradient max-w-[395px] rounded-[6px] text-white p-[20px] bg-[#161718]/80 backdrop-blur-sm'>
                    <div className='flex items-center justify-center gap-x-[4.5px]'>
                      <svg
                          ...
                          xmlns='http://www.w3.org/2000/svg'
                      >
                        <path d='M86.5 9.32121H1V0.824219V18.318' stroke='white' strokeWidth='2' />
                      </svg>
                      ...
                      <svg
                          ...
                          xmlns='http://www.w3.org/2000/svg'
                      >
                        <path d='M0.5 9.32121H86V0.824219V18.318' stroke='white' strokeWidth='2' />
                      </svg>
                    </div>
                  </div>
                </div>
            ...
            <div className='px-[58px] pb-[67px]'>
              ...
              <h5 className='text-white text-center text-[48px] font-[900] mb-[20px]'>
                {land.name} Land of Commerce
              </h5>
              <div className='flex justify-center mb-[30px]'>
                <p className='text-white/80 text-[14px] max-w-[890px]'>
