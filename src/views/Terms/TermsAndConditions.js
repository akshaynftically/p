...
const TermsAndConditions = () => {
  return (
    <Fragment>
       <h1 className='font-white text-[48px] mt-[5rem]'>TERMS OF USE</h1>

<div className='mb-[34px]'>
  <span className='inline-block font-medium text-[14px] bg-black py-[6px] px-[32px] rounded-[32px] font-white'>
    Last updated on: 06 June 2022
  </span>
</div>

<ol type='1' className='font-white px-10 ol'>
  ...
  <li className='li pl-2 mb-3'>
      ...
      <ol type='1' className='ol'>
              <li className='li pl-2 mb-3'>
                ...
                These Platform User Terms (these “Terms”) govern your access to, and use of products, services, and properties made available by COMEARTH.WORLD (“COMEARTH”, “we”, “us” or “our”) in the world’s first e-commerce metaverse ecosystem through this SaaS Platform. COMEARTH is a decentralized community- driven virtual platform which enables its users to carry out various commercial activities, and is created and owned by NFTICALLY and we act on behalf of the COMEARTH community as a whole. The COMEARTH does control the COMEARTH Metaverse, as governance is intended to be decentralized in future and then the COMEARTH will be governed by the community through the COMEARTH DAO (“DAO”). As used herein, the term “you” (including any variant) or “User” refers to each individual user who enters into these Terms on such individual’s own behalf or any entity on behalf of which an individual enters into these Terms. COMEARTH provides its Services (as described below), Metaverse (as described below), DAO, and DIY tools and/or materials made available from time to time by COMEARTH (collectively referred to as “Tools”) to you through this website, mobile applications (if any), VR applications, and SaaS Platform (the “Platform”), subject to the following Terms (as amended from time to time). 

<br/> <br/>
Our products, services and properties include, without limitation, virtual land parcels (the “Virtual Land”); avatar, wearables,NFT, or other non-fungible token (collectively “NFTs”); to help the owner of Virtual Land in building the store(s), storefront(s), experience center(s), engagement center(s), stadium(s), cinema hall(s), sports center(s), activity center(s), store(s), marketplace(s), shop(s), office(s), mall(s), or hub(s), etc. (collectively, the “Stores”); to enable market and sale, of certain digital, physical and phygital assets by adding them in the Stores or by minting digital items as NFT and provide or avail services within and outside of the COMEARTH Metaverse to potential buyers; to attend or organize virtual events in the COMEARTH; our online services shall help the owner or lessor of Stores to convert photos of its product in 3D and integrate logistics partners to sell the physical goods from within the COMEARTH, to run digital ads via a web interface created by COMEARTH (each referred to as a “Ads Platform”), and software provided on or in connection with those services (collectively, the “Service”).
<br/>
<br/>
COMEARTH is in its evolving phase and at this initial stage, we are launching the Platform and Tools for global trading of ownership of the Virtual Land available on COMEARTH Metaverse. You can buy, sell, trade, bid, search, and select Virtual Land to purchase in COMEARTH. At this stage our focus is on building the COMEARTH community and currently, we do not provide any other Services. As COMEARTH grows and develops in the near future the remaining Services will be launched at our sole discretion. 
              ...
              <li className='li pl-2 mb-3'>
                ...
                By signing up for an Account on the Platform or otherwise using or accessing the Platform or the Tools, you acknowledge that you have read and agree to these Terms. The Privacy Policy as set forth on the Platform are hereby incorporated by reference into these Terms and expressly agreed to and acknowledged by the User. These Terms, as amended from time to time and updated on the Platform shall, at all times, govern our relationship, and these Terms, unless excluded specifically in writing, shall prevail in the event of any conflict with any other agreement, document, letter, or instrument executed with you. 
              ...
              <li className='li pl-2 mb-3'>
                ...
                THESE TERMS OF USE ARE IMPORTANT AND AFFECT YOUR LEGAL RIGHTS, SO READ THEM CAREFULLY. BY CLICKING ON “Sign In” or “Login” or “Connect Wallet” BUTTON, COMPLETING THE ACCOUNT REGISTRATION PROCESS, AND/OR USING OR OTHERWISE ACCESSING THE TOOLS OR THE PLATFORM, YOU: (1) ACCEPT AND AGREE TO BE BOUND BY THESE TERMS AND ALL OF THE TERMS INCORPORATED HEREIN BY REFERENCE; (2) ACCEPT THAT TOOLS ARE STILL IN TESTING PHASE AND THAT YOU USE THEM AT YOUR OWN RISK; (3) REPRESENT THAT YOU HAVE ACHIEVED THE PERMISSIBLE AGE AS PER THE APPLICABLE LAWS TO USE THE TOOLS AND PLATFORM; AND (4) ACCEPT AND AGREE WITH ANY ADDITIONAL TERMS AND CONDITIONS OF PARTICIPATION ISSUED BY COMEARTH FROM TIME TO TIME. If you do not agree to these Terms, you may not access or use the Tools and Platform.
              ...
              <li className='li pl-2 mb-3'>
                ...
                Please refer to our Privacy Policy for information about how we collect, use, and share personal information about you. By submitting data through the Tools, you expressly consent to the collection, use, and disclosure of your personal data in accordance with the Privacy Policy.
              ...
              <li className='li pl-2 mb-3'>
                ...
                COMEARTH reserves the right to change or modify these Terms at any time and in our sole discretion. If we make changes to these Terms, we will provide notice of such changes, such as by sending an email notification, providing notice through the Tools, or updating the “Last Updated” date at the beginning of these Terms. COMEARTH shall not be responsible if you fail to receive the communication due to an incorrect email id provided by you or if you have not updated COMEARTH of your change in the email id. By continuing to access or use the Tools at any point after such update, you confirm your acceptance of the revised Terms and all of the terms incorporated therein by reference. We encourage you to review these Terms frequently to ensure that you understand the terms and conditions that apply when you access or use the Tools. If you do not agree to the revised Terms, you are free to reject them, unfortunately, that means you will no longer get access to or use the Tools.
  ...
  <li className='li pl-2 mb-3'>
                <span className='pl-2 mb-3 font-bold'>

                Our Service at Stage 1
...
<br/>
<p>
The Service is an online platform through which anyone can purchase, trade, bid, select, search, or sell Virtual Land in COMEARTH Metaverse     . You may only access the Tools and engage in traction related to Virtual Land by registering on the Platform, as described below.

</p>
<br/>
<br/>
You acknowledge that COMEARTH grants you a personal, non-exclusive, non-transferable, non-sublicensable (except to sub-users registered via the Tools), revocable, limited right to access and use the Tools through the Platform, which shall be solely used in compliance with these Terms provided herein and to the extent permitted under applicable laws, rules, and regulations.

As you are aware that at this stage we are only providing the Services relating to the sale, purchase, bid, or trade of Virtual Land you can purchase Virtual Land, and if you wish you can put them for re-sale in the COMEARTH Metaverse. Each piece of Virtual Land parcel in the COMEARTH Metaverse is sold as a non-fungible token and is included within the definition of NFT herein. Metaverse represents the time and space of your digital life in the COMEARTH and all kinds of commercial transactions whether related to the NFTs or any other goods or services in the COMEARTH take place in the Metaverse (“Metaverse”). 
<ol type='1' className='ol'>
<li className='li pl-2 mb-3'>
                <span className='pl-2 mb-3'>

                We are not a broker, or a financial institution, or a creditor, or a marketplace. COMEARTH through its Platform facilitates transactions between the buyer and seller of Virtual Land in a peer-to-peer manner and should neither be considered a marketplace nor a party, directly or indirectly,  to any agreement between the buyer and seller or otherwise between any Users of the Tools. 
              ...
              <li className='li pl-2 mb-3'>
                ...
                COMEARTH offers Platform as a service or any other "as a service" form (together as "SaaS"), using commercially reasonable efforts consistent with prevailing industry standards. 
              ...
              <li className='li pl-2 mb-3'>
                ...
                You bear full responsibility for verifying the identity, legitimacy, and authenticity of User Content and Virtual Land you buy or sell or market through the Tools. Notwithstanding indicators and messages that suggest verification, COMEARTH makes no claims and accepts no liability or responsibility about the identity, legitimacy, or authenticity of User Content, products, Services and NFTs offered for sale on or through the Platform.
              ...
              <li className='li pl-2 mb-3'>
            <span className='mt-3 font-bold pl-2 mb-3'>
            Terms and Conditions to Use this Platform
            </span>
            ...
            <li className='li pl-2 mb-3'>
                    ...
                    <li className='li pl-2 mb-3'>
                      ...
                      You may have more than one Account, and COMEARTH reserves the right to block multiple accounts of the same User at their sole discretion. You are solely responsible for the activity that occurs on your Account. You understand that we cannot be held responsible for the delay, loss, or incorrect distribution or activity in your Account. 
...
Share your Account password with anyone and you must keep your password safe, at all times.
                    ...
                    <li className='li pl-2 mb-3'>
                      ...
                      Log in or try to log in to access the Tools through unauthorized third-party applications or clients.
                      </span>
                    </li>
            </ol>
                    ...
                    <li className='li pl-2 mb-3'>
                      ...
                      COMEARTH may require you to provide additional information and documents at the request of any competent authority or in order to help COMEARTH comply with applicable law, regulation, or policy, including laws related to anti-laundering (legalization) of incomes obtained by criminal means, or for counteracting financing of terrorism. COMEARTH may also require you to provide additional information and documents in cases where it has reasons to believe that:
                    ...
                    <li className='li pl-2 mb-3'>
                      ...
                      Transactions effected via your Account effected in breach of these Terms.
                         </span>
                    </li>
            </ol>
            ...
            <li className='li pl-2 mb-3'>
                      ...
                      In such cases, COMEARTH, in its sole discretion, may pause or cancel your transactions until such requested additional information and documents have been reviewed by COMEARTH and accepted as satisfying the requirements of applicable law, regulation, or policy. Notwithstanding anything contained anywhere, if you do not provide complete and accurate information and documents in response to such a request, COMEARTH may refuse to provide any User Content, Virtual Land, Platform Content, product, service, and/or further access to the Tools to you.
                    ...
                    <li className='li pl-2 mb-3'>
                      ...
                      By providing your email id in the dashboard, you consent to receive electronic communications from COMEARTH (e.g., via email or by posting notices to the Tools). These communications may include without limitation notices about your Account (e.g., password changes and other transactional information); and information regarding COMEARTH products and Tools and are part of your relationship with us. You agree that any notices, agreements, disclosures, or other communications that we send to you electronically will satisfy any legal communication requirements, including, but not limited to, any requirements that such communications be in writing. You should maintain copies of electronic communications from us by printing a paper copy or saving an electronic copy. We have no obligation to store for your later use or access any such electronic communications that we make to you. We may also send you promotional communications via email, including, but not limited to, newsletters, special offers, product and Tools information, surveys and other news and information related to COMEARTH or any of the COMEARTH Service that we think will be of interest to you. By creating an Account, you consent to COMEARTH to receive all such communication from COMEARTH which includes offer that will complement or expand the Tools and any third party product and services .You may opt out of receiving these promotional emails at any time by sending an email to hello@comearth.world. 
                    ...
                    <li className='li pl-2 mb-3'>
                      ...
                      By creating an Account, you authorize COMEARTH to use your name and logo and/or link of the Virtual Land, and Metaverse Store for the limited purposes of promoting COMEARTH and its Tools to the public worldwide. The promotional materials may include, but are not limited to, brochures, video tape, internet website, press releases, advertising in newspaper and/or other periodicals, and any other material, as COMEARTH may decide solely in its own discretion. It is however, clarified that COMEARTH acquires no ownership rights in the logo, Virtual Land, and Metaverse Store  owned by you and such activities shall be restricted to promoting us and making our Tools accessible to more users of the world wide web.
                    ...
                    <li className='li pl-2 mb-3'>
                      ...
                      Users are required to keep themselves updated about the news and updates from the COMEARTH team in order to timely participate in ongoing events. User can follow COMEARTH on its social handles or join its communities on its official Discord, Twitter, or Telegram to receive all updates around COMEARTH. Users are advised to ensure that the handles they follow and the communities they join are the official COMEARTH entities, as mentioned in our website and whitepaper. The COMEARTH team shall not be liable in case a user is unable to participate in an event of their choice due to lack of information or misinformation. This includes the Virtual Land Allocation on the COMEARTH Planet Map once the landscape is launched.
                    ...
                    <li className='li pl-2 mb-3'>
                      ...
                      The COMEARTH team reserves the rights to launch Blockchain based tokens for COMEARTH in the future. Future policies that violate or hinder the planning and execution of the token launch shall not be entertained and if posited shall be considered invalid.
                    ...
                    <li className='li pl-2 mb-3'>
                      ...
                      Then you register for an Account, you hereby represent and warrant, to and for the benefit of COMEARTH and its affiliates, as follows:

                      <ol type='1' className='ol'>
                      <li className='li pl-2 mb-3'>
                      <span className='pl-2 mb-3'>

                      Authority. You have all requisite capacity, power, and authority to enter into and perform your obligations under these Terms, including to buy or sell Virtual Land , organize virtual events in COMEARTH; creating a Store; or carry out any commercial activity in the COMEARTH Metaverse in accordance with this Term. The execution, delivery, and the performance of your obligations under, these Terms have been duly authorized by all necessary action on your part and on the part of any entity on behalf of which you are entering into these Terms, and no other proceedings are necessary to authorize the execution, delivery, or performance of your obligations under these Terms.
                    ...
                    <li className='li pl-2 mb-3'>
                      ...
                      Due Execution. These Terms constitute your legal, valid, and binding obligation, enforceable against you in accordance with these Terms. You have achieved the legal age of majority in your jurisdiction as is required to access such Tools, Platform Content and User Content and enter into arrangements as provided by the Tools. 
  </span>
                    </li>
                    <li className='li pl-2 mb-3'>
                      <span className='pl-2 mb-3'>

                      Accuracy of Information. All information provided to COMEARTH, including any address and social security number or tax ID number, is accurate and complete. None of: (i) you; (ii) any affiliate of any entity on behalf of which you are entering into these Terms; (iii) any other person having a beneficial interest in any entity on behalf of which you are entering into these Terms (or in any affiliate thereof); or (iv) any person for whom you are acting as agent or nominee in connection with these Terms is: (A) a country, territory, entity or individual named on an OFAC list as provided at http://www.treas.gov/ofac, or any person or entity prohibited under the OFAC programs, regardless of whether or not they appear on the OFAC list; or (B) a senior foreign political figure, or any immediate family member or close associate of a senior foreign political figure.
    </span>
                    </li>
                    <li className='li pl-2 mb-3'>
                      <span className='pl-2 mb-3'>

                      Non-Contravention. These Terms do not, and the performance of your obligations under these Terms and your access and using the Tools will not: (i) if you are entering into these terms on behalf of an entity, conflict with or violate any of the charter documents of such entity or any resolution adopted by its equity holders or other persons having governance authority over the entity; (ii) contravene, conflict with or violate any right of any third party or any legal requirement applicable to you or to any of the assets owned or used by you; or (iii) result in any breach of or constitute a default (or an event that with notice or lapse of time or both would become a default) under any material contract or agreement to which you are a party, permit held by you or legal requirement applicable to you.
    </span>
                    </li>
                    <li className='li pl-2 mb-3'>
                      <span className='pl-2 mb-3'>

                      Independent Investigation and Non-Reliance. You are sophisticated, experienced, and knowledgeable regarding the Virtual Land and risk associated with the same, in organizing virtual events,  the setting up of      Store in Metaverse for minting, listing, selling, or trading of any NFTs, or to carry out any permissible commercial activity in the COMEARTH Metaverse, additionally, you have conducted an independent investigation of the Tools and the matters contemplated by these Terms, have formed your own independent judgment regarding the benefits and risks of and necessary and desirable practices regarding the foregoing and, in making the determination to engage in transactions related to Virtual Land, organising events, setting up Store to mint, list, sell or trade any NFTs using the Tools, or engage in any permissible commercial activity in the Metaverse, you have relied solely on the results of such investigation and such independent judgment. Without limiting the generality of the foregoing, you understand, acknowledge and agree that the legal requirements pertaining to blockchain technologies and digital assets generally, including the NFTs and metaverse, are evolving, and you have conducted an independent investigation of such potentially applicable legal requirements and the resulting risks and uncertainties, including the risk that one or more governmental entities or other persons may assert that any digital assets or cryptographic tokens (including the Virtual Land) may constitute securities under applicable legal requirements. You hereby irrevocably disclaim and disavow reliance upon any statements or representations made by or on behalf of, or information made available by, COMEARTH, in determining to enter into these Terms, for engaging in transactions related to Virtual Land, organising events, setting up of Store, carrying out any commercial activity in the Metaverse, or using the Tools.
   </span>
                    </li>
                    <li className='li pl-2 mb-3'>
                      <span className='pl-2 mb-3'>

                      Litigation. There is no legal proceeding pending that relates to your activities relating to the sale of Virtual Land, or other token- or digital asset- trading or blockchain technology related activities.    </span>
                    </li>
                    <li className='li pl-2 mb-3'>
                      <span className='pl-2 mb-3'>

                      Intellectual Property and Related Matters. You are the sole and exclusive owner of all right, title and interest in and to all rights, including intellectual property rights, incorporated into or otherwise used, held for use or practiced in connection with (or planned by you to be incorporated into or otherwise used, held for use or practiced in connection with) the NFT, any Off-Chain Benefits and the minting of the NFT, other than any intellectual property rights that are validly licensed (or provided on a hosted basis) to you pursuant to valid and binding licenses granted to you.
    </span>
                    </li>
                    <li className='li pl-2 mb-3'>
                      <span className='pl-2 mb-3'>

                      Compliance. You have not failed to comply with, and have not violated, any applicable legal requirement, law, or regulation, including, without limitation, relating to any blockchain technologies, token trading activities, Metaverse, Virtual Land, or, minting NFTs. No investigation or review by any governmental entity is pending or, to your knowledge, has been threatened against or with respect to you, nor does any government order or action prohibit you or any of your representatives from engaging in or continuing any conduct, activity or practice relating to selling or buying Virtual Land, setting up of Store, carrying out any commercial activity in the Metaverse, or using the Tools. You understand and agree that you are responsible for ensuring compliance with the laws of your jurisdiction and acknowledge that COMEARTH is not liable for your compliance or failure to comply with such laws.
    </span>
                    </li>
                    <li className='li pl-2 mb-3'>
                      <span className='pl-2 mb-3'>

                      You must provide all equipment and software necessary to connect to the Tool. You are solely responsible for any fees, including internet connection or mobile fees, that you incur when accessing the Tools.    </span>
                    </li>
                    <li className='li pl-2 mb-3'>
                      <span className='pl-2 mb-3'>

                      You will not violate the security of any computer network, or crack any password, account, or other security information of any other User while using the Tools. You will not upload any User Content which contains software viruses or any other computer code, files or programs designed to interrupt, destroy or limit the functionality of any computer software or hardware or telecommunications equipment; (i) poses or creates a privacy or security risk to any person; (ii) constitutes unsolicited or unauthorized advertising, promotional materials, commercial activities and/or sales, “junk mail,” “spam,” “chain letters,” “pyramid schemes,” “contests,” “sweepstakes,” or any other form of solicitation; (iii) is unlawful, harmful, threatening, abusive, harassing, tortious, excessively violent, defamatory, vulgar, obscene, pornographic, libellous, invasive of another’s privacy, hateful racially, ethnically or otherwise objectionable; or (iv) in the judgment of the COMEARTH , is objectionable or which restricts or inhibits any other person from using or enjoying the Platform/Tool, or which may expose COMEARTH, or its Users to any harm or liability of any type.
    </span>
                    </li>
                    <li className='li pl-2 mb-3'>
                      <span className='pl-2 mb-3'>

                      You will not attempt to probe or probe, scan, or test the vulnerability of any COMEARTH server or network or breach any security or authentication measures and you will not attempt to avoid or circumvent any technological measure implemented by COMEARTH      to protect the Tools or Platform Content on the Platform, including without limitation, encryption technology used to protect sensitive personal information.
                          </span>
                    </li>
                    <li className='li pl-2 mb-3'>
                      <span className='pl-2 mb-3'>

                      You will not use the Platform or Tools to harvest, collect, gather, or assemble information or data regarding other Users, including email addresses, without their consent   </span>
                    </li>
                    <li className='li pl-2 mb-3'>
                      <span className='pl-2 mb-3'>

                      You will not use any robots, spider, crawler, scraper, script, deep link, or other similar automated data gathering or extraction tool, program, algorithm or methodology to access, copy, modify or monitor the Platform.
                          </span>
                    </li>
                    <li className='li pl-2 mb-3'>
                      <span className='pl-2 mb-3'>

                      You will not use, employ, operate, or create a computer program to simulate the human behaviour of a User (“Bots”), and or use, employ, or operate such Bots or other similar forms of automation to engage in any activity or transaction on the Platform or Tools.   </span>
                    </li>
                    <li className='li pl-2 mb-3'>
                      <span className='pl-2 mb-3'>

                      You do not further promote any criminal activity or enterprise or provide instructional information about illegal activities, including for the purpose of concealing economic activity, laundering money, or financing terrorism. You are solely responsible for all activities conducted through your Account whether or not you authorize the activity.
    </span>
                    </li>
                    <li className='li pl-2 mb-3'>
                      <span className='pl-2 mb-3'>

                      You are not manipulating the price of Virtual Land, in any way, including bidding on your own Virtual Land, preventing bidding, or using COMEARTH to conceal economic activity. You will not engage in or knowingly facilitate any “front-running”, “wash trading”, “pump and dump trading”, “ramping”, “cornering” or fraudulent, deceptive, or manipulative trading activities including: trading Virtual Land at lower or higher prices to create a false, misleading appearance of activity in such Virtual Land, influencing the market price for such Virtual Land or establishing a price which does not reflect the true state of the market in such Virtual Land  (including bidding on your own Virtual Land,  or preventing bidding), executing or causing the execution of any transaction in Virtual Land which involves no material change in the beneficial ownership thereof; 
entering any order for the purchase or sale of Virtual Land,  with the knowledge that order of substantially the same size, and at substantially the same price, for the sale of such Virtual Land, has been or will be entered by or for the same or different parties; 
participating in, facilitating, assisting, or knowingly transacting with any pool, syndicate, or joint account organized for unfairly or deceptively influencing the market price of Virtual Land .
   </span>
                    </li>
                    <li className='li pl-2 mb-3'>
                      <span className='pl-2 mb-3'>

                      You do not further, promote, mint, sell any NFT, create User Content, organise events, engage in any commercial activity in COMEARTH, or introduce User Content in your Virtual Land which may represent or promote vulgarity, sex abuse, complete nudity, child abuse, child harassment, child sexual harassment, animal torture, animal pornography, drugs, violence, racism, Nazi symbols etc. If COMEARTH makes a decision that your User Content is not appropriate, then COMEARTH has complete right and authority to remove or delete any such User Content and/or stop any event being organised in COMEARTH and/or shut down the Store of Users who repeatedly promote such acts.
                          </span>
                    </li>
            </ol>
                    ...
                    <li className='li pl-2 mb-3'>
                      ...
                      You understand that in order to provide the Tools contemplated hereunder, COMEARTH is dependent on third-party service providers or vendors. You agree and acknowledge that COMEARTH will not be responsible under any circumstances for any delays or deficiencies in the provision of, or access to, the Tools to the extent that such delays or deficiencies are caused by any third-party service providers or vendors. You expressly agree that this paragraph is intended to be as broad as permitted by the applicable laws. COMEARTH is not under an obligation to provide any communication about any such downtime to you. Any downtime in the Tools due to downtime or delay in services of a third-party service provider or vendor shall not be considered COMEARTH’s downtime.
   </span>
                    </li>
                    ...
                    <li className='li pl-2 mb-3'>
                      ...
                      You understand that the COMEARTH has made available the Tools and Platform free of charge in order to allow effective interactions in the COMEARTH and COMEARTH has no continuing obligation to operate the Tools and the Platform and may cease to operate one or more of the Tools in the future, at its exclusive discretion, with no liability whatsoever in connection thereto.
                        </span>
                    </li>
                    ...
                    <li className='li pl-2 mb-3'>
                      ...
                      In the event, a User who is an entity, on behalf of whom an individual enters into these Terms does not have its own terms and condition in relation to its Stores, or its goods, or services, or any transaction thereof, then these Terms shall apply in relation to the transaction with such User to the extent relevant provided COMEARTH does not accept any liability, obligation, consequence, or responsibility of the User, its client, or any third party. 
   </span>
                    </li>
            ...
            <li className='li pl-2 mb-3'>
                      ...
                      The size and positioning of the Virtual Land is established and controlled by us in our sole discretion The first-sale of each tile of Virtual Land will be based on a value that we assign to it. User may submit an offer to COMEARTH to buy the Virtual Land at the price displayed on the Platform. If COMEARTH accepts that offer, the price plus Platform Commission will be deducted from the User’s Account. Future sales between registered Users will be struck at a price agreed between those Users.
                    ...
                    <li className='li pl-2 mb-3'>
                      <span className='pl-2 mb-3'>
                      All subsequent sales of Virtual Land between registered Users must be conducted through the Metaverse that we provide on the Platform for that purpose. We do not promise that the Metaverse  will be always available, or that there will be an uninterrupted connection between the Metaverse and any payment Account.
    ...
    If the registered User who holds the rights in any Virtual Land wishes to sell that Virtual Land, it can place the Virtual Land for sale on the Metaverse. Other registered Users can bid on that Virtual Land, and the successful buyer (as determined by the seller User) will become eligible to take ownership of the Virtual Land, subject to paying the agreed price to the seller for the relevant Virtual Land, and payment to us of the relevant Platform Commission. Ownership in the Virtual Land will pass on confirmation to our satisfaction of successful and complete payment of the agreed sale price and our Platform Commission. If payment is not successfully received, then the sale will not proceed.
                    ...
                    <li className='li pl-2 mb-3'>
                      ...
                      All title and ownership rights over each piece of Virtual Land belongs to its owner. Each owner of the Virtual Land decides its User Content to be included in the Virtual Land and may impose its own terms and conditions and policies. You are advised to review any such terms, conditions and policies before entering into transactions in any Virtual Land. The COMEARTH does not control the User Content of each Virtual Land and does not assume any liability or obligation in connection thereto. The COMEARTH holds the intellectual property rights over the Virtual Land      but does not have any intellectual property right over the User Content introduced by each User on its Virtual Land.
                 ...
                 When you buy a Virtual Land and make it available for sale in the Metaverse, you retain ownership of all intellectual property rights associated with such Virtual Land. End Users who purchase the Virtual Land own that purchased Virtual Land as NFT completely and have the right to sell, trade, donate, give away, transfer, or otherwise dispose of the NFT as they see fit in accordance with these Terms; provided, however, that each Virtual Land remain      tokenized so that it will have provable scarcity and proof of ownership.
                    ...
                    <li className='li pl-2 mb-3'>
                      ...
                      Your rights in any Virtual Land are not ‘ownership’ and are conferred by contract only for the purposes of transacting within the Metaverse as a registered User. Those rights are expressly subject to all of the terms that apply to use of the Platform, and require you to remain a registered User.
                    ...
                    <li className='li pl-2 mb-3'>
                      ...
                      You understand that the value of Virtual Land may fluctuate from time to time depending upon various factors and there is no inherent value in any Virtual land.
                    ...
                    <li className='li pl-2 mb-3'>
                      ...
                      We reserve the right in future to convert your holding of Virtual Land to an equivalent value of a crypto-currency that we may create in the future. Any conversion would be conducted at a valuation reasonably determined by us.
                    ...
                    <li className='li pl-2 mb-3'>
                      ...
                      Rights in the Virtual Land are not assignable from your Account to any other Account other than by ‘sale’ as contemplated by these Terms. If your membership is cancelled in accordance with these Terms, or you cancel your use of the Platform for any reason, you forfeit any Virtual Land assigned to your Account and we are not liable to you in any way (including without limitation for the payment of any amount in respect of the relevant Virtual Land). The ownership of any Virtual Land so forfeited returns to us, and will be made available for sale to other Users at the price determined by us.
            ...
            <li className='li pl-2 mb-3'>
                      ...
                      The Tools may in future include the ability for you to make certain content available on or through the Tools (“User Content”). All User Content must comply with these Terms. 
                    ...
                    <li className='li pl-2 mb-3'>
                      <span className='pl-2 mb-3'>
                      You represent and warrant that such User Content will not jeopardizes the security of your Account or anyone else’s and will not be libellous or defamatory and that you have, or have obtained, all rights, licenses, consents, permissions, power and/or authority necessary to grant the rights granted herein for any User Content that you submit, post, or display on or through the Tools. You agree that such User Content will not contain material the use of which as permitted herein is violative of copyright or other proprietary rights and all your User Content do comply with these Terms. 
                    ...
                    <li className='li pl-2 mb-3'>
                      ...
                      Any User Content publicly posted or privately transmitted through the Tool is the sole responsibility of the person from whom such content originated, and you access all such content and material at your own risk. COMEARTH cannot control and has no duty to take action regarding how you may interpret and use the User Content or what actions you may take as a result of having been exposed to the content. COMEARTH cannot guarantee the identity of any Users with whom you interact in using the Tools.
            ...
            <li className='li pl-2 mb-3'>
                      ...
                      All pricing plans and payment terms are indicated on Pricing Page and shall appear before completion of sign up for an account with us. Any payment obligations you incur are binding after you sign up for an account with us for the Tools. Please carefully review the terms and conditions contained or expressly referenced on the Pricing Page. 
                    ...
                    <li className='li pl-2 mb-3'>
                      ...
                      Any transaction related to Virtual Land taking place in the Metaverse will be subject to a 5% commission (“Platform Commission”) calculated over the total value of such transaction. Such Platform Commission will be borne by the User of the transaction. You authorize us to collect the Platform Commission. You acknowledge and agree that Platform Commission will be transferred directly to us through the Polygon network or any other network that we may support as part of your payment.
                    ...
                    <li className='li pl-2 mb-3'>
                      ...
                      To participate as a buyer or seller of a Virtual Land in the Metaverse, you must connect to a browser extension called MetaMask or any other wallet allowed by us. You shall use electronic wallet which allows you to purchase, store, and engage in transactions using the ERC-20 based tokens including but not limited to WETH, Matic, USDT and other tokens processed by a smart contract on the Polygon blockchain or any other blockchain supported by us for all payments made in cryptocurrency. You can also buys these tokens using your debit or credit card as some wallets have enabled this feature. All transactions on COMEARTH Metaverse can be conducted in various cryptocurrencies. You represent and warrant that you are authorized to use the payment method you use via COMEARTH to make purchase for any Virtual Land. You authorize COMEARTH to charge your payment method for the total amount of your purchase price of the Virtual Land. Your order may be suspended or cancelled for any reason, including if the payment method cannot be verified, is invalid, or is otherwise not acceptable. We have no liability to you or to any third party for any claims or damage that may arise as a result of any payment or transactions that you engage via COMEARTH.
                    ...
                    <li className='li pl-2 mb-3'>
                      ...
                      You agree to adhere to following conditions while using ERC20 tokens for a transaction on COMEARTH:
                      <ol type='1' className='ol'>
                      <li className='li pl-2 mb-3'>
                <span className='pl-2 mb-3'>
                While using ERC20 token as a currency during a transaction, you should ensure that it is free from restrictions and can be easily traded in decentralized exchanges or centralized exchanges
              
                </span>
              </li>
              <li className='li pl-2 mb-3'>
                <span className='pl-2 mb-3'>
                The ERC20 token must have enough trade volume in order to let COMEARTH swap it with respective blockchain’s native coins.
              ...
              <li className='li pl-2 mb-3'>
                <span className='pl-2 mb-3'>
                In case, the ERC20 token is not listed on any of the exchange as per the above, it will be your responsibility to convert the ERC20 token into native coins of fiat money as and when required by COMEARTH to materialize the Platform Commission.
