...
console.log(emailReadOnly)
    if(!emailReadOnly){
      ...
      console.log(email)
       localStorage.setItem('transaction_form',JSON.stringify({...transactionForm,email:email}))
    }
}, [emailReadOnly])
