...
// Sources
import _illustartion from 'assets/img/illustration/2.png'
      ...
      <div className='mx-[20px] lg:mx-[80px] relative z-[2]'>
        <div className='grid grid-cols-12 items-center gap-x-[30px]'>
          <div className='order-2 md:order-1 col-span-12 md:col-span-6'>
            <img className='lg:hidden' src={_illustartion} alt='Illustration'/>

            <h1 className='leading-tight font-extrabold text-[32px] lg:text-[52px] mb-[24px]'>
              We are on a mission to make <span className='text-gradient'>Web3.0 E-Commerce a reality</span>
            </h1>
            <div className='text-[16px] text-white/[.80] mb-[20px]'>
