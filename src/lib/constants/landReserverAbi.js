export const _landReserverAbi = [
    ...
    },
    {
      ...
      "name": "getQuantityPurchasedPerBuyer",
      "outputs": [
        {
          "internalType": "uint256[6]",
          "name": "",
    ...
    {
      "inputs": [],
      "name": "getTotalSalesEquivalentInUSD",
      "outputs": [
        {
          "internalType": "uint256",
          "name": "",
    ...
    {
      "inputs": [],
      "name": "getParcelTypeWiseSalesEquivalentInUSD",
      "outputs": [
        {
          "internalType": "uint256[6]",
          "name": "",
    ...
    {
      "inputs": [],
      "name": "getParcelTypeWiseSales",
      "outputs": [
        {
          "internalType": "uint256[12][6]",
          "name": "",
          "type": "uint256[12][6]"
        }
      ],
