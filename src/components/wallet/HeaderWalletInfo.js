    ...
    return (
        <div className='ml-auto'>
            {!accounts.length
                ? (
                    <>
                        <SimpleButton type='button' className='hidden md:block' onClick={connectWallet}>
                        ...
                        <button className='py-[5px] px-[10px] md:hidden bg-[#3F99FF] hover:bg-[#7A3FE4] rounded-[8px]' onClick={connectWallet}>
