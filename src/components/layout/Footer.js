const Footer = () => {
  return (
    <div className='footer-container z-[1] fixed left-0 right-0 bottom-0'>
      <footer className='sm:max-w-[90rem] 2xl:max-w-[105rem] text-gray-400 sm:items-end w-full mx-auto px-4 sm:px-6 lg:px-8 flex flex-wrap basis-full items-center pb-[32px]'>
